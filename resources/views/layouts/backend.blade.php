        ...
        <div id="page-container" class="sidebar-o enable-page-overlay sidebar-dark side-scroll page-header-fixed main-content-narrow">
            ...
            <aside id="side-overlay" class="font-size-sm">
                ...
                <div class="content-header border-bottom">
                    ...
                    <!-- User Info -->
                    <div class="ml-2">
                        <a class="text-dark font-w600 font-size-sm" href="javascript:void(0)">{{session()->get('admin')['username']}}</a>
                    </div>
                    <!-- END User Info -->
                                ...
                                <ul class="nav-main-submenu">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link {{ request()->is('client-details/*') ? ' active' : '' }} {{ request()->is('client-details') ? ' active' : '' }}" href="/client-details">
                                            <span class="nav-main-link-name">Details</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0" aria-labelledby="page-header-user-dropdown">
                                <!--<div class="p-3 text-center bg-primary-dark rounded-top">
                                    ...
                                    <p class="mt-2 mb-0 text-white font-w500">{{session()->get('admin')['username']}}</p>
                ...
                <div class="content py-3">
                    <div class="row font-size-sm">
                        ...
                        <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">
                            <a class="font-w600" href="/dashboard">Licrapro</a> &copy; <span data-toggle="year-copy"></span>
                        </div>
                    </div>
                </div>
            </footer>
